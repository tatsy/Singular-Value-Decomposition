...
public:
    ...
    explicit POINTER_QUEUE(const int size) : array_size(size + 1), array(new void *[size + 1] - 1), front(1), back(1) {}

    ~POINTER_QUEUE() { delete[] (array + 1); }
    ...
    void *Peek() const { return array[front]; }
    ...
    bool Empty() const { return back == front; }

    bool Full() const { return Size() == array_size - 1; }
